...
- [x] **LEARN-03**: All agent learning records use consistent 4-field schema: `claim`, `applies_to`, `confidence`, `evidence_artifact_id` — low confidence is the default; medium/high requires evidence
