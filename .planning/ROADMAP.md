...
- [ ] 15-04-PLAN.md — Update TOOLS.md with drafts/ directory reference, processed-ids.jsonl format spec, trim command, and mark-read command reference (TRIAGE-03, TRIAGE-04)
